...
Route::middleware('auth:web', 'verified')->prefix('reservation')->controller(ReservationController::class)->group(function () {
...
Route::middleware('auth:web', 'verified')->prefix('review')->controller(ReviewController::class)->group(function () {
